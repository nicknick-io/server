...
export const smithables : Map<string, Map<string, Smithable>> = new Map<string, Map<string, Smithable>>([
    ['dagger', new Map<string, Smithable>([
        ['bronze', {
            ...
            ingredient: { itemId: itemIds.bronzeBar, amount: 1 }
        }],
        ['iron', {
            level: 15,
            experience: 25,
            item: { itemId: itemIds.daggers.iron, amount: 1 },
            ingredient: { itemId: itemIds.ironBar, amount: 1 }
        }],
        ['steel', {
            level: 30,
            experience: 37.5,
            item: { itemId: itemIds.daggers.steel, amount: 1 },
            ingredient: { itemId: itemIds.steelBar, amount: 1 }
        }],
        ['mithril', {
            level: 50,
            experience: 50,
            item: { itemId: itemIds.daggers.mithril, amount: 1 },
            ingredient: { itemId: itemIds.mithrilBar, amount: 1 }
        }],
        ['adamant', {
            level: 70,
            experience: 62.5,
            item: { itemId: itemIds.daggers.adamant, amount: 1 },
            ingredient: { itemId: itemIds.adamantiteBar, amount: 1 }
        }],
        ['rune', {
            level: 85,
            experience: 75,
            item: { itemId: itemIds.daggers.rune, amount: 1 },
            ingredient: { itemId: itemIds.runiteBar, amount: 1 }
        }],
    ])],
    ['axe', new Map<string, Smithable>([
        ['bronze', {
            level: 1,
            experience: 12.5,
            item: { itemId: itemIds.bronzeAxe, amount: 1 },
            ingredient: { itemId: itemIds.bronzeBar, amount: 1 }
        }],
        ['iron', {
            level: 16,
            experience: 25,
            item: { itemId: itemIds.ironAxe, amount: 1 },
            ingredient: { itemId: itemIds.ironBar, amount: 1 }
        }],
        ['steel', {
            level: 31,
            experience: 37.5,
            item: { itemId: itemIds.steelAxe, amount: 1 },
            ingredient: { itemId: itemIds.steelBar, amount: 1 }
        }],
        ['mithril', {
            level: 51,
            experience: 50,
            item: { itemId: itemIds.mithrilAxe, amount: 1 },
            ingredient: { itemId: itemIds.mithrilBar, amount: 1 }
        }],
        ['adamant', {
            level: 71,
            experience: 62.5,
            item: { itemId: itemIds.adamantiteAxe, amount: 1 },
            ingredient: { itemId: itemIds.adamantiteBar, amount: 1 }
        }],
        ['rune', {
            level: 86,
            experience: 75,
            item: { itemId: itemIds.runiteAxe, amount: 1 },
            ingredient: { itemId: itemIds.runiteBar, amount: 1 }
        }],
    ])],
    ['mace', new Map<string, Smithable>([
        ['bronze', {
            level: 2,
            experience: 12.5,
            item: { itemId: itemIds.bronzeMace, amount: 1 },
            ingredient: { itemId: itemIds.bronzeBar, amount: 1 }
        }],
        ['iron', {
            level: 17,
            experience: 25,
            item: { itemId: itemIds.ironMace, amount: 1 },
            ingredient: { itemId: itemIds.ironBar, amount: 1 }
        }],
        ['steel', {
            level: 32,
            experience: 37.5,
            item: { itemId: itemIds.steelMace, amount: 1 },
            ingredient: { itemId: itemIds.steelBar, amount: 1 }
        }],
        ['mithril', {
            level: 52,
            experience: 50,
            item: { itemId: itemIds.mithrilMace, amount: 1 },
            ingredient: { itemId: itemIds.mithrilBar, amount: 1 }
        }],
        ['adamant', {
            level: 72,
            experience: 62.5,
            item: { itemId: itemIds.adamantiteMace, amount: 1 },
            ingredient: { itemId: itemIds.adamantiteBar, amount: 1 }
        }],
        ['rune', {
            level: 87,
            experience: 75,
            item: { itemId: itemIds.runiteMace, amount: 1 },
            ingredient: { itemId: itemIds.runiteBar, amount: 1 }
        }],
    ])],
    ['mediumHelm', new Map<string, Smithable>([
        ...
        level: 3,
            experience: 12.5,
            item: { itemId: itemIds.bronzeMediumhelm, amount: 1 },
            ingredient: { itemId: itemIds.bronzeBar, amount: 1 }
        }],
        ['iron', {
            level: 18,
            experience: 25,
            item: { itemId: itemIds.ironMediumhelm, amount: 1 },
            ingredient: { itemId: itemIds.ironBar, amount: 1 }
        }],
        ['steel', {
            level: 33,
            experience: 37.5,
            item: { itemId: itemIds.steelMediumhelm, amount: 1 },
            ingredient: { itemId: itemIds.steelBar, amount: 1 }
        }],
        ['mithril', {
            level: 53,
            experience: 50,
            item: { itemId: itemIds.mithrilMediumhelm, amount: 1 },
            ingredient: { itemId: itemIds.mithrilBar, amount: 1 }
        }],
        ['adamant', {
            level: 73,
            experience: 62.5,
            item: { itemId: itemIds.adamantiteMediumhelm, amount: 1 },
            ingredient: { itemId: itemIds.adamantiteBar, amount: 1 }
        }],
        ['rune', {
            level: 88,
            experience: 75,
            item: { itemId: itemIds.runiteMediumhelm, amount: 1 },
            ingredient: { itemId: itemIds.runiteBar, amount: 1 }
        }]
    ])],
    ['bolts', new Map<string, Smithable>([
        ['bronze', {
            level: 3,
            experience: 12.5,
            item: { itemId: itemIds.bronzeBolts, amount: 15 },
            ingredient: { itemId: itemIds.bronzeBar, amount: 1 }
        }],
        ['iron', {
            level: 18,
            experience: 25,
            item: { itemId: itemIds.ironBolts, amount: 15 },
            ingredient: { itemId: itemIds.ironBar, amount: 1 }
        }],
        ['steel', {
            level: 33,
            experience: 37.5,
            item: { itemId: itemIds.steelBolts, amount: 15 },
            ingredient: { itemId: itemIds.steelBar, amount: 1 }
        }],
        ['mithril', {
            level: 53,
            experience: 50,
            item: { itemId: itemIds.mithrilBolts, amount: 15 },
            ingredient: { itemId: itemIds.mithrilBar, amount: 1 }
        }],
        ['adamant', {
            level: 73,
            experience: 62.5,
            item: { itemId: itemIds.adamantiteBolts, amount: 15 },
            ingredient: { itemId: itemIds.adamantiteBar, amount: 1 }
        }],
        ['rune', {
            level: 88,
            experience: 75,
            item: { itemId: itemIds.runiteBolts, amount: 15 },
            ingredient: { itemId: itemIds.runiteBar, amount: 1 }
        }],
    ])],
    ['sword', new Map<string, Smithable>([
        ['bronze', {
            level: 4,
            experience: 12.5,
            item: { itemId: itemIds.bronzeSword, amount: 1 },
            ingredient: { itemId: itemIds.bronzeBar, amount: 1 }
        }],
        ['iron', {
            level: 19,
            experience: 25,
            item: { itemId: itemIds.ironSword, amount: 1 },
            ingredient: { itemId: itemIds.ironBar, amount: 1 }
        }],
        ['steel', {
            level: 34,
            experience: 37.5,
            item: { itemId: itemIds.steelSword, amount: 1 },
            ingredient: { itemId: itemIds.steelBar, amount: 1 }
        }],
        ['mithril', {
            level: 54,
            experience: 50,
            item: { itemId: itemIds.mithrilSword, amount: 1 },
            ingredient: { itemId: itemIds.mithrilBar, amount: 1 }
        }],
        ['adamant', {
            level: 74,
            experience: 62.5,
            item: { itemId: itemIds.adamantiteSword, amount: 1 },
            ingredient: { itemId: itemIds.adamantiteBar, amount: 1 }
        }],
        ['rune', {
            level: 89,
